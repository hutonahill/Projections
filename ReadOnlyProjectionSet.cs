...
public class ReadOnlyProjectionSet<TSource, TValue> : IReadOnlySet<TValue> {
    private readonly ISet<TSource> _source;
    private readonly Func<TSource, TValue> _projector;
    private readonly IEqualityComparer<TValue> _comparer;

    /// <summary>
    /// Initializes a new instance of the <see cref="ReadOnlyProjectionSet{TSource,TValue}"/> class.
    /// </summary>
