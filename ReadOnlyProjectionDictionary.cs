...
public sealed class ReadOnlyProjectionDictionary<TKey, TValue, TSource> : IReadOnlyDictionary<TKey, TValue> {
    private readonly IDictionary<TKey, TSource> _source;
    private readonly Func<TSource, TValue> _projector;

    /// <summary>
    /// Initializes a new instance of the <see cref="ReadOnlyProjectionDictionary{TKey,TValue,TSource}"/> class.
    /// </summary>
    /// <param name="source">The source dictionary.</param>
    /// <param name="convert">Function to convert the internal source type to the external type.</param>
    public ReadOnlyProjectionDictionary(IDictionary<TKey, TSource> source, Func<TSource, TValue> convert) {
        _source = source;
        _projector = convert;
    }
